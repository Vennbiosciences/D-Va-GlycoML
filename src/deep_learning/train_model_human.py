...
def train_model_human(train_path, test_path, saved_model_path):
    """
...
def user_interface(train_path, test_path, saved_model_path):
    ...
    :return:
    """
    #  python train_model_human.py -TA=/data/Training-01-Human-285/N-GP-PKL
    ...
    train_model_human(train_path, test_path, saved_model_path)
...
if __name__ == "__main__":
    ...
    # -SM=/data/saved_models/train-15_test-4_batch-8_14-Apr-2022
    #
    # python train_model_human.py -TA=D:\data\Training-01-Human-285\N-GP-PKL
    ...
    # nohup python -u train_model_human.py -TA=/data/Training-01-Human-285/N-GP-PKL
    # -TE=/data/Testing-01-Different-HCD-energies-24/Energy-01-HCD-15-20-34-37-40/N-GP-PKL
    # -SM=/data/saved_models/train-15_test-4_batch-8_14-Apr-2022
