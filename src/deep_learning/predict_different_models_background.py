...
Modified on 10 May 2022, for the background running, to solve the permission issue.
########################################################################################################################
"""
__author__ = 'ZLiang'
...
def predict_models(model_path, input_type, top_number, test_path):
    ...
    for i in range(num_saved_models):
        ...
        print(f"The total number of predicted samples in all testing files: {len(precisions_total)} ")
